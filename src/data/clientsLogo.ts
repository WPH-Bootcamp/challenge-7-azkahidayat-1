...
import Dropbox from '@/assets/images/client-logo/dropbox.svg?react';
import Netflix from '@/assets/images/client-logo/netflix.svg?react';
import Paypal from '@/assets/images/client-logo/paypal.svg?react';
...
export const clientsLogos: ClientsLogo[] = [
  ...
  { id: 2, name: 'Airbnb', logo: Airbnb },
  { id: 3, name: 'Databricks', logo: Databricks },
  { id: 4, name: 'Dropbox', logo: Dropbox },
  { id: 5, name: 'Netflix', logo: Netflix },
  { id: 6, name: 'Paypal', logo: Paypal },
  { id: 7, name: 'Postman', logo: Postman },
  { id: 8, name: 'Upwork', logo: Upwork },
  { id: 9, name: 'Zoom', logo: Zoom },
];
